...
var file_test_proxy_proto_rawDesc = []byte{
	...
	,
...
var file_test_proxy_proto_goTypes = []interface{}{
	...
	(*v2.RowFilter)(nil),                 // 21: google.bigtable.v2.RowFilter
	(*status.Status)(nil),                // 22: google.rpc.Status
	(*v2.Row)(nil),                       // 23: google.bigtable.v2.Row
	(*v2.ReadRowsRequest)(nil),           // 24: google.bigtable.v2.ReadRowsRequest
	(*v2.MutateRowRequest)(nil),          // 25: google.bigtable.v2.MutateRowRequest
	(*v2.MutateRowsRequest)(nil),         // 26: google.bigtable.v2.MutateRowsRequest
	(*v2.MutateRowsResponse_Entry)(nil),  // 27: google.bigtable.v2.MutateRowsResponse.Entry
	(*v2.CheckAndMutateRowRequest)(nil),  // 28: google.bigtable.v2.CheckAndMutateRowRequest
	(*v2.CheckAndMutateRowResponse)(nil), // 29: google.bigtable.v2.CheckAndMutateRowResponse
	(*v2.SampleRowKeysRequest)(nil),      // 30: google.bigtable.v2.SampleRowKeysRequest
	(*v2.SampleRowKeysResponse)(nil),     // 31: google.bigtable.v2.SampleRowKeysResponse
	(*v2.ReadModifyWriteRowRequest)(nil), // 32: google.bigtable.v2.ReadModifyWriteRowRequest
}
var file_test_proxy_proto_depIdxs = []int32{
	20, // 0: google.bigtable.testproxy.CreateClientRequest.per_operation_timeout:type_name -> google.protobuf.Duration
	...
	21, // 2: google.bigtable.testproxy.ReadRowRequest.filter:type_name -> google.bigtable.v2.RowFilter
	22, // 3: google.bigtable.testproxy.RowResult.status:type_name -> google.rpc.Status
	23, // 4: google.bigtable.testproxy.RowResult.row:type_name -> google.bigtable.v2.Row
	24, // 5: google.bigtable.testproxy.ReadRowsRequest.request:type_name -> google.bigtable.v2.ReadRowsRequest
	22, // 6: google.bigtable.testproxy.RowsResult.status:type_name -> google.rpc.Status
	23, // 7: google.bigtable.testproxy.RowsResult.rows:type_name -> google.bigtable.v2.Row
	25, // 8: google.bigtable.testproxy.MutateRowRequest.request:type_name -> google.bigtable.v2.MutateRowRequest
	22, // 9: google.bigtable.testproxy.MutateRowResult.status:type_name -> google.rpc.Status
	26, // 10: google.bigtable.testproxy.MutateRowsRequest.request:type_name -> google.bigtable.v2.MutateRowsRequest
	22, // 11: google.bigtable.testproxy.MutateRowsResult.status:type_name -> google.rpc.Status
	27, // 12: google.bigtable.testproxy.MutateRowsResult.entries:type_name -> google.bigtable.v2.MutateRowsResponse.Entry
	28, // 13: google.bigtable.testproxy.CheckAndMutateRowRequest.request:type_name -> google.bigtable.v2.CheckAndMutateRowRequest
	22, // 14: google.bigtable.testproxy.CheckAndMutateRowResult.status:type_name -> google.rpc.Status
	29, // 15: google.bigtable.testproxy.CheckAndMutateRowResult.result:type_name -> google.bigtable.v2.CheckAndMutateRowResponse
	30, // 16: google.bigtable.testproxy.SampleRowKeysRequest.request:type_name -> google.bigtable.v2.SampleRowKeysRequest
	22, // 17: google.bigtable.testproxy.SampleRowKeysResult.status:type_name -> google.rpc.Status
	31, // 18: google.bigtable.testproxy.SampleRowKeysResult.samples:type_name -> google.bigtable.v2.SampleRowKeysResponse
	32, // 19: google.bigtable.testproxy.ReadModifyWriteRowRequest.request:type_name -> google.bigtable.v2.ReadModifyWriteRowRequest
	1,  // 20: google.bigtable.testproxy.CloudBigtableV2TestProxy.CreateClient:input_type -> google.bigtable.testproxy.CreateClientRequest
	3,  // 21: google.bigtable.testproxy.CloudBigtableV2TestProxy.CloseClient:input_type -> google.bigtable.testproxy.CloseClientRequest
	5,  // 22: google.bigtable.testproxy.CloudBigtableV2TestProxy.RemoveClient:input_type -> google.bigtable.testproxy.RemoveClientRequest
	7,  // 23: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadRow:input_type -> google.bigtable.testproxy.ReadRowRequest
	9,  // 24: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadRows:input_type -> google.bigtable.testproxy.ReadRowsRequest
	11, // 25: google.bigtable.testproxy.CloudBigtableV2TestProxy.MutateRow:input_type -> google.bigtable.testproxy.MutateRowRequest
	13, // 26: google.bigtable.testproxy.CloudBigtableV2TestProxy.BulkMutateRows:input_type -> google.bigtable.testproxy.MutateRowsRequest
	15, // 27: google.bigtable.testproxy.CloudBigtableV2TestProxy.CheckAndMutateRow:input_type -> google.bigtable.testproxy.CheckAndMutateRowRequest
	17, // 28: google.bigtable.testproxy.CloudBigtableV2TestProxy.SampleRowKeys:input_type -> google.bigtable.testproxy.SampleRowKeysRequest
	19, // 29: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadModifyWriteRow:input_type -> google.bigtable.testproxy.ReadModifyWriteRowRequest
	2,  // 30: google.bigtable.testproxy.CloudBigtableV2TestProxy.CreateClient:output_type -> google.bigtable.testproxy.CreateClientResponse
	4,  // 31: google.bigtable.testproxy.CloudBigtableV2TestProxy.CloseClient:output_type -> google.bigtable.testproxy.CloseClientResponse
	6,  // 32: google.bigtable.testproxy.CloudBigtableV2TestProxy.RemoveClient:output_type -> google.bigtable.testproxy.RemoveClientResponse
	8,  // 33: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadRow:output_type -> google.bigtable.testproxy.RowResult
	10, // 34: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadRows:output_type -> google.bigtable.testproxy.RowsResult
	12, // 35: google.bigtable.testproxy.CloudBigtableV2TestProxy.MutateRow:output_type -> google.bigtable.testproxy.MutateRowResult
	14, // 36: google.bigtable.testproxy.CloudBigtableV2TestProxy.BulkMutateRows:output_type -> google.bigtable.testproxy.MutateRowsResult
	16, // 37: google.bigtable.testproxy.CloudBigtableV2TestProxy.CheckAndMutateRow:output_type -> google.bigtable.testproxy.CheckAndMutateRowResult
	18, // 38: google.bigtable.testproxy.CloudBigtableV2TestProxy.SampleRowKeys:output_type -> google.bigtable.testproxy.SampleRowKeysResult
	8,  // 39: google.bigtable.testproxy.CloudBigtableV2TestProxy.ReadModifyWriteRow:output_type -> google.bigtable.testproxy.RowResult
